    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        ...
        {currentView === 'client' && selectedClient && (
          <a
            href={`https://wa.me/393123456789?text=Ciao!%20Ho%20bisogno%20di%20assistenza%20per%20la%20mia%20contabilità.%0ACliente:%20${selectedClient.name}%0AProblema:%20`}
            target="_blank"
